			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<input type="hidden" name="ACTION" id="BANNER_ACTION" value="BANNER" />
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a href="#" class="btn btn-warning" data-dismiss="modal">Cancel</a>
						<input class="btn btn-primary" type="submit"
							value="Save Changes" id="btn-other-settings">
					</div>
				</div>
			</div>
		</form>
		    ...
		    $('#form-other-settings').bootstrapValidator({
		        ...
		        fields: {
		            ...
		            loginField: {
		                validators: {
		                    notEmpty: {
		                        message: 'Please select the prefered login field (must be unique to every agent)'
		                    }
		                }
		            }
		        }
