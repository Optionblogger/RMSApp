...
<div class="container-fluid section">
    <h3 class="text-center main-title">
        <i class="fa fa-cloud-upload"></i>&nbsp;ADD PROPERTY BATCH
    </h3>
    <div class="col-md-6">
        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#importPropertyBatch">
            Upload
            Batch
        </button>
    </div>
...
<!-- Modal -->
<div class="modal fade" id="importPropertyBatch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form role="form" id="form-add-propertyBatch">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Property Batch Upload</h4>

                </div>
                <div class="modal-body">
                    <input type="hidden" name="ACTION" id="ACTION" value="PROPERTY_BATCH"/>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <span class="control-fileupload">
          <label for="propertyBatch">Choose Excel File :</label> <input type="file" id="propertyBatch"
                                                                        name="propertyBatch">
        </span>
                            </div>
                        </div>
        ...
        <div class="modal-dialog large-modal">
            <div class="modal-content">
                ...
                <div class="modal-body" style=" width: 1000px;margin: auto; background-color: #ffffff"
                    ...
                    <h2 style="text-align: center; color: #2b669a; font-family: 'Roboto'; font-size: 24px;">
                        PROPERTY</h2>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#form-add-rentBatch')
            ...
            .on(
                ...
                function (e) {
                    e.preventDefault();
                    var btn = "btn-file";
                    var form = "form-add-propertyBatch";
                    var modal = "importPropertyBatch";
                    $('#' + btn).val('Please wait...');
        ...
        function viewPropertyBatchExceptions() {
            $.ajax({
                url: $('#base_url').val() + 'admin',
                type: 'post',
                data: {
                    ACTION: 'VIEW_PROPERTY_BATCH_EXCEPTIONS'
                },
                dataType: 'html',
