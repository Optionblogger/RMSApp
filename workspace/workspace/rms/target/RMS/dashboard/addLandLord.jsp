...
<div class="container-fluid section">
    <h3 class="text-center main-title">
        <i class="glyphicon glyphicon-flash"></i>LANDLORD REGISTRATION
    </h3>
    <div class="row">
        <form class="form-horizontal" method="post" id="form-landlord">
            <fieldset>
                <div class="col-sm-5">
                    ...
                    <%--<div class="form-group">
                        <label for="landlordPassword" class="control-label">Password:</label> <input
                    ...
                    <div class="form-group">
                        <label for="landLordConfirmPassword" class="control-label">Confirm Password:</label> <input
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            <select class="form-control pull-left landlord-country-code"
                                    name="country-code" style="width: 35%;"></select>
                            <input type="text" name="landlordCellNumber"
                                   class="form-control"
                                   id="landlordCellNumber" placeholder="Phone Number"
                                   style="width:65%"
