...
<div id="accordion-container">
     ...
     <div class="accordion-content">
          <p>Access Agents registered through the portal</p>
          <table class="table table-responsive table-striped">
     ...
     <div class="accordion-content">
          <p>Access Landlord registered through the portal</p>
          <table class="table table-responsive table-striped">
      ...
      <h2 class="accordion-header">AGENT OPERATIONS<span class="pull-right"><input type="checkbox" id="agent_operations" class="form-control input-sm"  ${permissions.operations == 'TRUE' ? 'checked' : ''}/></span></h2>
     <div class="accordion-content">
          <p>Access to Agents operations, i.e. view member information and edit details</p>
           <table class="table table-responsive table-striped">
