...
<div class="container-fluid section">
    <h3 class="text-center main-title">
        <i class="fa fa-th"></i>&nbsp;&nbsp;VIEW &nbsp; AGENTS
    </h3>
    ...
    <table class="table table-responsive table-striped">
        ...
        <c:forEach var="agent" items="${agents}">
            ...
            <tr>
                ...
                <td>${ agent.address.postalAddress }</td>
...
<script type="text/javascript">
    function removeAgent(id, name) {
        bootbox.confirm("<p class=\"text-center\">Are you sure you want to remove Agent  <strong>\"" + name + "\"</strong>. Are you sure?</p>", function (result) {
                if (result) {
                    // start_wait();
                    $.ajax({
                        url: $('#base_url').val() + 'admin',
                        type: 'post',
                        data: {ACTION: 'REMOVE_AGENT', agentId: id},
                        dataType: 'json',
    ...
    function viewAgentDetails(id) {
        $.ajax({
            url: $('#base_url').val() + 'admin',
            type: 'post',
            data: {ACTION: 'VIEW_AGENT_DETAILS', agentId: id},
            dataType: 'html',
            success: function (html) {
                $('#update_agent-content').html(html);
    ...
    $(document).ready(function () {
        $(".agent-edit-country-code").append(
        ...
        $('#form-edit-agent').bootstrapValidator(
            {
                excluded: ':disabled',
            ...
            .on(
                ...
                function (e) {
                    ...
                    var modal = "modal-edit-agent";
                    var phonecode = $('.agent-edit-country-code').val();
                    ...
                    e.preventDefault();
                    var form = "form-edit-agent";
                    $.ajax({
                        url: $('#base_url').val() + 'admin',
                        type: 'post',

                        data: {
                            ACTION: 'EDIT_AGENTINFO',
                            agentId: $('#agentId').val(),
                            emailAddress: $(
                                '#agentEmailaddress')
                                .val(),
...
<div class="modal fade" id="modal-edit-agent" tabindex="-1" role="dialog"
    ...
    <form role="form" id="form-edit-agent" enctype="multipart/form-data">
        <div class="modal-dialog large-modal">
            <div class="modal-content">
                <div class="modal-body" id="update_agent-content">
