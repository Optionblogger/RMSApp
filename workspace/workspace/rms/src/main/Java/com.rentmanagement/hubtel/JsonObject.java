 ...
 *
 * <pre>
 * for( Member agent : jsonObject ) {
 *   String name = agent.getName();
 *   JsonValue value = agent.getValue();
 *   ...
 * }
 * </pre>
 * <p>
...
public class JsonObject extends JsonValue implements Iterable<JsonObject.Member> {
    ...
    /**
     * Adds a new agent at the end of this object, with the specified name and
     ...
     * agent with a name that already exists in the object will add another
     * agent with the same name. In order to replace existing members, use the
     ...
     * @param value the value of the agent to add
     ...
     *
     * @param name the name of the agent to add
     * @param value the value of the agent to add, must not be
     * <code>null</code>
     * @return the object itself, to enable method chaining
     */
    ...
    /**
     * Sets the value of the agent with the specified name to the JSON
     * representation of the specified <code>int</code> value. If this object
     * does not contain a agent with this name, a new agent is added at the
     ...
     * </p>
     *
     * @param name the name of the agent to replace
     * @param value the value to set to the agent
     * @return the object itself, to enable method chaining
     */
     ...
     * object does not contain a agent with this name, a new agent is added at
     ...
     * agent with this name, a new agent is added at the end of the object. If
    ...
    /**
     * Sets the value of the agent with the specified name to the specified
     * JSON value. If this object does not contain a agent with this name, a
     * new agent is added at the end of the object. If this object contains
    ...
    /**
     * Removes a agent with the specified name from this object. If this object
     * contains multiple members with the given name, only the last one is
     * removed. If this object does not contain a agent with the specified
    ...
    /**
     * Returns the value of the agent with the specified name in this object.
     * If this object contains multiple members with the given name, this method
     * will return the last one.
     *
     * @param name the name of the agent whose value is to be returned
     * @return the value of the last agent with the specified name, or
     * <code>null</code> if this object does not contain a agent with that name
     */
    ...
    /**
     * Represents a agent of a JSON object, i.e. a pair of name and value.
     */
    public static class Member {
         ...
         *
         * @return the name of this agent, never <code>null</code>
         */
         ...
         *
         * @return the value of this agent, never <code>null</code>
         */
