...
<div class="container-fluid section">
    <h3 class="text-center main-title" id="title">
        <i class="fa fa-bell"></i>&nbsp;&nbsp;SEND NOTIFICATIONS TO TENANTS
    </h3>
    <form class="form-horizontal" method="post" id="form-tenant-notifications">
        <div class="row">
            ...
            .on(
                ...
                function (e) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: {
                            ACTION: 'SEND_TENANTS_NOTIFICATION',
                            to: $('#to').val(),
                            subject: $('#subject')
                                .val(),
                            message: $('#message')
                        ...
                        success: function (json) {
                            $("form#form-tenant-notifications")[0]
                                .reset();
