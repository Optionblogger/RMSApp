...
<div class="container-fluid section">
    <h3 class="text-center main-title">
        <i class="fa fa-cloud-upload"></i>&nbsp;&nbsp;ADD TENANT BATCH
    </h3>
    <div class="col-md-6">
        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#importTenantBatch">Upload
            Batch
        </button>
    </div>
    <p>&nbsp;</p>
...
<!-- Modal -->
<div class="modal fade" id="importTenantBatch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form role="form" id="form-add-tenantBatch">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Tenant Batch Upload</h4>

                </div>
                <div class="modal-body">
                    <input type="hidden" name="ACTION" id="ACTION" value="TENANT_BATCH"/>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <span class="control-fileupload">
          <label for="tenantBatch">Choose Excel File :</label>

                        <input type="file" class="filestyle" data-buttonName="btn-primary" id="tenantBatch"
                               name="tenantBatch" data-buttonBefore="true" multiple/>
        </span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#form-add-tenantBatch').bootstrapValidator({
            ...
            e.preventDefault();
            var btn = "btn-file";
            var form = "form-add-tenantBatch";
            var modal = "importTenantBatch";
            $('#' + btn).val('Please wait...');
        ...
        function viewTenantBatchExceptions() {
            $.ajax({
                url: $('#base_url').val() + 'agent',
                type: 'post',
                data: {
                    ACTION: 'VIEW_TENANT_BATCH_EXCEPTIONS'
                },
                dataType: 'html',
